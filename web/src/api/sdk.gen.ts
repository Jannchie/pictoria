 ...
 */
export const v2AutoSiglipScorer = <ThrowOnError extends boolean = false>(options: Options<V2AutoSiglipScorerData, ThrowOnError>) => (options.client ?? client).put<V2AutoSiglipScorerResponses, V2AutoSiglipScorerErrors, ThrowOnError>({ url: '/v2/cmd/siglip-scorer', ...options });
