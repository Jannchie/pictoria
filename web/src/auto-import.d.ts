...
declare global {
  ...
  const describeAPIError: typeof import('./composables/useAPIError').describeAPIError
  ...
  const useElementOffset: typeof import('./composables/useElementOffset').useElementOffset
  ...
  const useSelectedPostStats: typeof import('./composables/useSelectedPostStats').useSelectedPostStats
