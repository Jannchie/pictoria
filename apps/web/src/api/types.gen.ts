...
export type ClientOptions = {
    baseURL: 'http://127.0.0.1:4777' | (string & {});
};
...
/**
 * ListwiseQueueItemPublic
 */
export type ListwiseQueueItemPublic = {
    position: number;
    posts: Array<QueueItemPostPublic>;
};
...
export type V2SubmitListwiseData = {
    body: ListwiseEventIn;
    path?: never;
    query?: never;
...
export type V2SubmitListwiseResponse = V2SubmitListwiseResponses[keyof V2SubmitListwiseResponses];
...
export type V2SampleListwiseData = {
    body?: never;
    path?: never;
    query?: {
        limit?: number;
...
export type V2CreateListwiseData = {
    body: ListwiseQueueCreate;
    path?: never;
    query?: never;
...
export type V2CreateListwiseResponse = V2CreateListwiseResponses[keyof V2CreateListwiseResponses];
...
export type V2NextListwiseData = {
    body?: never;
    path: {
        queue_id: number;
    };
...
export type V2NextListwiseResponse = V2NextListwiseResponses[keyof V2NextListwiseResponses];
...
export type V2GenerateListwiseData = {
    body: GenerateListwiseIn;
    path?: never;
    query?: never;
...
export type V2GenerateListwiseResponse = V2GenerateListwiseResponses[keyof V2GenerateListwiseResponses];
